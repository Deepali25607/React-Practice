...
<div>
<p> I am about page:{this.props.match.params.id}</p> 
  <div className={"w3-content"} props-style={{"max-width":"1100px" }}>
  <div className={"w3-row w3-padding-64"} id="about">
  <div className={"w3-col m6 w3-padding-large w3-hide-small"}>
   <img src={tablesetting2} class={"w3-round w3-image w3-opacity-min"} alt="Table Setting" width="600" height="750" />
  </div>
